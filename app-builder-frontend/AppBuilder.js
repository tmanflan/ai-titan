...
export default function TitanForge() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--color-bg)', color: 'var(--color-text)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', padding: 0 }}>
      ...
      <main style={{ width: '100%', maxWidth: 800, margin: '2rem auto', background: 'var(--color-accent-grey)', borderRadius: 16, boxShadow: '0 4px 24px var(--color-accent-purple)', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
